...
foreign VulkanMemoryAllocator {
	...
	CalculateStats                                                       :: proc(allocator : Allocator, pStats : ^Stats) ---;
	GetBudget                                                            :: proc(allocator : Allocator, pBudget : ^Budget) ---;
	BuildStatsString                                                     :: proc(allocator : Allocator, ppStatsString : ^cstring, detailedMap : b32) ---;
	...
	DefragmentationBegin                                                 :: proc(allocator : Allocator, pInfo : ^DefragmentationInfo2, pStats : ^DefragmentationStats, pContext : ^DefragmentationContext) -> vk.Result ---;
	DefragmentationEnd                                                   :: proc(allocator : Allocator, context_ : DefragmentationContext) -> vk.Result ---;
	BeginDefragmentationPass                                             :: proc(allocator : Allocator, context_ : DefragmentationContext, pInfo : ^DefragmentationPassInfo) -> vk.Result ---;
	EndDefragmentationPass                                               :: proc(allocator : Allocator, context_ : DefragmentationContext) -> vk.Result ---;
	Defragment                                                           :: proc(allocator : Allocator, pAllocations : ^Allocation, allocationCount : uint, pAllocationsChanged : ^b32, pDefragmentationInfo : ^DefragmentationInfo, pDefragmentationStats : ^DefragmentationStats) -> vk.Result ---;
